...
class ResNet(nn.Module):
    def __init__(
        ...
        self.inplanes = int(width_per_group * widen)
        self.dilation = 1
        ...
        num_out_filters = int(width_per_group * widen)
...
def resnet50w(widen, **kwargs):
    return ResNet(Bottleneck, [3, 4, 6, 3], widen=widen, **kwargs)
